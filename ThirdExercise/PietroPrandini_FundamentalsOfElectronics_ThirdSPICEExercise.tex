...
\subsection{MOSFET $M_1$ and MOSFET $M_2$ - Common mode $V_{i_1} = V_{i_2} = V_{CM}$}



\section{SPICE Operating Point analysis - Common mode $V_{i_1} = V_{i_2} = V_{CM} = 0$}
\lstinputlisting{netlist/DifferentialAmplifierVCMzero.cir}
\lstinputlisting{netlist/DifferentialAmplifierVCMzero.op}
