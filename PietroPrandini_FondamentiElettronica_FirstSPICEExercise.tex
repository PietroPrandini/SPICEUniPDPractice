...
The netlist used for plot the output voltage waveform with an input voltage dobled relatively to the maximum input voltage calculated is:\\
...
\begin{figure}[H]
  ...
  \caption{Audio Amplifier - Output voltage with an amplitude of the imput voltage equal to $2*1.36701V$, frequency equal to 10Hz}
  \label{1d4cgraph}
\end{figure}
